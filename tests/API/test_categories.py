...
class TestCategories:
    ...
    def test_create_category(self, name, status_code, category_api, get_settings_and_session_postgre):
        ...
        db_cat = Category(
            session=get_settings_and_session_postgre['session'], data={"name": name})
        db_data = db_cat.get(table_name=Category,
    ...
    def test_read_category(self, category_api, get_settings_and_session_postgre):
        ...
        db_cat = Category(
            session=get_settings_and_session_postgre['session'], data=create_response.json())
